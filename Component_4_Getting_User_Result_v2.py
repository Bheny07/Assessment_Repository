"""Adding on from Component_4_Getting_User_Result_v1 and making it so that the
user gets told if their answer is correct e.g. What number is Wha?, user types
in 4 and the code will print 'Correct'. If the user gets it incorrect, the code
will say 'Incorrect' and will tell the user the right answer.
This version will also tell the user the score after each question e.g. '
Correct' 'Your score is 2/5' """
